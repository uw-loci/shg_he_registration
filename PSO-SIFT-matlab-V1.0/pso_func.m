function [outputArg1,outputArg2] = pso_func(image_1,image_2, image_raw, image_name)
...
[M,N,P]=size(image_1);
ff=imtransform(image_raw,tform, 'XData',[1 N], 'YData',[1 M]);
str1=['.\save_image\',image_name];
imwrite(ff,str1);
t2=clock;
